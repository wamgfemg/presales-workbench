...
(function () {
  ...
  var CAP_MIGRATE = [
    ...
    { id: 'ck7', category: '招投标实务', title: '必须参与评分标准制作', content: '**为什么要参与**：评分标准就是中标方程式，谁参与制定规则谁掌握先机。售前必须在招标文件评标办法定稿前介入，把自己方案的差异化优势转化为可打分的评分项，而不是等标准定完再被动应标。**怎么参与**：①摸清评分构成——价格／技术／商务权重、客观分与主观分占比、是否有最高限价；②把我方能力写成可举证、可量化的加分项或星号（▲）参数，让对手难以满足；③技术参数保持合规、指向性能而非唯一品牌，避免排他性条款引发质疑投诉；④业绩、资质、人员证书等客观分严格对齐我方真实条件，别把门槛抬到自己也够不着。**红线**：不得围标串标、不得为特定品牌量身定制排他条款；参与控标＝用合规方式放大自身优势，绝非操纵评标专家。落点：对应「售前四步节奏」第④步招投标控标。', tags: '评分标准,控标,评标办法,招投标', updatedAt: Date.now() },
    { id: 'ck8', category: '商务与报价', title: '报价三维定位法', content: '**报价前先算清三条线**——**成本线**：自身交付成本＋合理利润，守住不亏的底线；**竞争线**：预判对手报价区间与低价抢标风险；**价值线**：以客户可量化的收益（省钱／增收／降风险）为锚，支撑高于对手的价格。三线夹出报价区间。原则：先讲价值再谈价格，报价留缓冲；每次降价都要换回条件（付款更优、范围调整、年限延长或案例授权），不做无原则让利。', tags: '报价,商务,定价,控价', updatedAt: Date.now() },
    { id: 'ck9', category: '演讲与呈现', title: '述标开场90秒定胜负', content: '**开场 90 秒**决定评委注意力：先讲对客户业务与痛点的理解、再讲我方价值，切忌一上来念产品清单。PPT 原则——一页一个论点、图大于表、表大于大段文字，标题就是结论句。**分对象切换**：面向决策者讲收益与风险，面向技术评委讲可行性与参数响应。节奏上控制时长、留足答疑，关键页停顿强调，眼神覆盖主评委。', tags: '述标,演讲,PPT,呈现', updatedAt: Date.now() },
    { id: 'ck10', category: '演讲与呈现', title: '述标答疑控场', content: '答疑是失分重灾区，也是翻盘机会：①没听清先复述确认问题，争取思考时间；②能答的直接给结论＋佐证页码；③答不了或需验证的，坦诚记录并承诺补材料时间点，切忌现场编数据；④对质疑参数或业绩的，提前备好应答话术与证明材料。姿态：不辩解、不对抗评委，把质疑转成补充说明的入口。', tags: '述标,答疑,控场,应变', updatedAt: Date.now() }
  ];
